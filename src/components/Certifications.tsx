...
const Certifications = () => {
  const certifications: Certification[] = [
    ...
    { 
      ...
      issuer: "Cisco",
      file: "/portfolio/certifications/ccna-introduction-to-networks.png"
    },
    { 
      name: "CCNA Introduction to Networks - Certificate", 
      issuer: "Cisco",
      file: "/portfolio/certifications/nadhirbenhalima-3GI-CCNA1-S1-202-certificate (1).pdf"
    },
    { 
      name: "CCNA Introduction to Networks - Letter", 
      issuer: "Cisco",
      file: "/portfolio/certifications/nadhirbenhalima-3GI-CCNA1-S1-202-letter.pdf"
    },
    ...
    { 
      ...
      issuer: "IBM",
      file: "/portfolio/certifications/IBMDeveloperSkillsNetwork BC0201EN Certificate _ Cognitive Class.pdf"
    },
    { 
      name: "Hadoop (BD0111EN)", 
      issuer: "IBM",
      file: "/portfolio/certifications/IBM BD0111EN Certificate _ Cognitive Class.pdf"
    },
    { 
      name: "Big Data Fundamentals (BD0101EN)", 
      issuer: "IBM",
      file: "/portfolio/certifications/IBM BD0101EN Certificate _ Cognitive Class.pdf"
    },
    { 
      name: "Spark Fundamentals (BD0211EN)", 
      issuer: "BigDataUniversity",
      file: "/portfolio/certifications/BigDataUniversity BD0211EN Certificate _ Cognitive Class.pdf"
    },
    { name: "Supervised & Unsupervised Learning with scikit-learn", issuer: "Datacamp" },
    { 
      name: "Introduction to Data Science (DS0101EN)", 
      issuer: "Cognitive Class",
      file: "/portfolio/certifications/Cognitive Class DS0101EN Certificate _ Cognitive Class.pdf"
    },
